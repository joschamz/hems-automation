"""
prices.py — Day-ahead electricity price utility, modelled after solar.py.
...
Output columns
--------------
- time           (datetime64, UTC, timezone-aware)   — matches solar.py's `time` column
...
def get_daily_prices(
    ...
    secrets_dir : str | Path
        ...
        Resolved with the same two-candidate logic as solar.py's config path.
    allow_fallback : bool
...
# ---------------------------------------------------------------------------
# Internal helpers — path / config resolution (mirrored from solar.py)
# ---------------------------------------------------------------------------
